 ...
 */
final class Version20181207112907 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE loaning (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, start DATETIME DEFAULT NULL, end DATETIME DEFAULT NULL, user VARCHAR(255) DEFAULT NULL, INDEX IDX_38DDD8D0EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
